...
# --- All Backend Functions and Constants ---
...
def show_login_page():
    ...
    with cols[1]:
        # Applying glass-card style via a markdown div wrapper
...
def show_main_app():
    with st.sidebar:
        ...
        # Re-enabled and functional theme toggle
        def theme_changed():
    ...
    # Corrected JS injection to apply theme to the correct document body
    ...
    # --- FIXED: Vertical Layout to Prevent Overlap ---
    ...
    # (Save logic would be here, but is complex to show; it's handled by comparing dataframes)
